...
**Release:** [2.9.18](https://github.com/FlightControl-Master/MOOSE/releases/tag/2.9.18)
OOP mission scripting framework. The de facto standard for complex missions. Provides AI dispatchers, logistics, JTAC, ATIS, MANTIS IADS, spawn management, tasking, F10 menus, and more. Load order: MOOSE first, then your script.
